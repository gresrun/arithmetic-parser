...
/**
 * An implementation of ArithmeticParser that creates a dynamic class to
...
public class JavassistArithmeticParser implements ArithmeticParser {
    ...
    /**
     * An implementation of ArithmeticParser that always returns zero. Used as a
     * basis for Javassist-created parsers.
     * 
     * @author Greg Haines
     */
